...
Expected output:
    Scenario 1 (solo counsellor):
      counsellor: Truong An tier=0 flat_local=1000000 gross=1000000

    Scenario 2 (counsellor + CO paired):
      counsellor: Truong An tier=0 flat_local=500000 gross=500000
      case_officer: Hoang Yen tier=0 flat_local=500000 gross=500000
"""
