...
// "Du học (Ghi danh + visa)". Mirrors FkCell exactly, only swapping
// numeric id for string code as the saved value.
function CodeSelectCell({
  ...
  // Find label for the currently saved code. Falls back to raw code if
  // no match (defends against legacy data with removed codes).
